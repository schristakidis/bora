...
if system() == 'Windows':
	module1 = Extension('bora',
                    ...
                    sources = ['bora.c', 'blockcache.c', 'netencoder.c', 'ack.c', 'ack_received.c', 'packet_receiver.c', 'packet_sender.c', 'biter_bridge.c', 'bpuller_bridge.c', 'stats_bridge.c', 'recv_stats.c', 'bw_stats.c', 'bw_msgs.c'])
else:
	module1 = Extension('bora',
                    define_macros = [('DEF1', '1'),
                                     ('DEF2', '0')],
